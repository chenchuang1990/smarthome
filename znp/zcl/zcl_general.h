...
#define zclGeneral_SendIdentifyQuery(a,b,c,d,e) zcl_sendcommand( (a), (b), (c), ZCL_CLUSTER_ID_GEN_IDENTIFY, COMMAND_IDENTIFY_QUERY, TRUE, ZCL_FRAME_CLIENT_SERVER_DIR, (d), 0, (e), 0, NULL)
//#endif // ZCL_IDENTIFY
 ...
 */
extern ZStatus_t zclGeneral_SendIdentify( uint8 srcEP, uint8 dstEP, uint16 dstAddr,
