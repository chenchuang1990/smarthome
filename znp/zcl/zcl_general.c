                                   ...
                                   uint16 identifyTime, uint8 disableDefaultRsp, uint8 seqNum )
{
  ...
  return zcl_sendcommand(srcEP, dstEP, dstAddr, ZCL_CLUSTER_ID_GEN_IDENTIFY, COMMAND_IDENTIFY, TRUE, ZCL_FRAME_CLIENT_SERVER_DIR, disableDefaultRsp, 0, seqNum, 2, buf);
}
