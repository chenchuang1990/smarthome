...
typedef struct
{
  ...
  zclCfgReportRec_t attrList[10]; // attribute ID list
} zclCfgReportCmd_t;
...
// ------------------------------------------------------------------------ ZCL_WRITE
// ------------------------------------------------------------------------ ZCL_REPORT
extern ZStatus_t zcl_SendConfigReportCmd( uint8 srcEP, uint8 dstEp, uint16 dstAddr,
                          uint16 realClusterID, zclCfgReportCmd_t *cfgReportCmd,
                          uint8 direction, uint8 disableDefaultRsp, uint8 seqNum );

extern ZStatus_t zcl_SendReadReportCfgCmd( uint8 srcEP, uint8 dstEp, uint16 dstAddr,
